...
*/
int feslite_solve(int n, const uint32_t * F, uint32_t * solutions, int max_solutions);
...
int feslite_kernel_solve(int i, int n, const uint32_t * F, uint32_t * solutions, int max_solutions);