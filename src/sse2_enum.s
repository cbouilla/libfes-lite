...
################################################################################
# This file was auto-generated by sse2_codegen.py
...
### extern struct solution_t * UNROLLED_CHUNK(const __m128i * Fq, __m128i * Fl, u64 alpha, 
###                                           u64 beta, u64 gamma, struct solution_t *local_buffer)

.text
.p2align 5

.globl feslite_sse2_asm_enum
feslite_sse2_asm_enum:

# multiply alpha, beta, gamma by 16
shlq $4, %rdx
shlq $4, %rcx
shlq $4, %r8

vpxor %xmm15, %xmm15, %xmm15         # set %xmm15 to always-zero
...
movdqa 96(%rdi), %xmm13   ## %xmm13 = Fq[6]
