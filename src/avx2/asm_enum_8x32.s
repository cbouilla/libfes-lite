...
.globl feslite_avx2_asm_enum_8x32
### void avx2_asm_enum_8x32(__m256i *F, uint64_t alpha_shift, void *buf, uint64_t *num, uint64_t idx);
...
# variable ('F', 0) maps to %ymm0
# variable ('F', 1) maps to %ymm1
# variable ('F', 2) maps to %ymm2
# variable ('F', 3) maps to %ymm3
# variable ('F', 4) maps to %ymm4
# variable ('F', 5) maps to %ymm5
# variable ('F', 6) maps to %ymm6
# variable ('F', 7) maps to %ymm7
# variable ('F', 8) maps to %ymm8
# variable ('F', 9) maps to %ymm9
# variable ('F', 10) maps to %ymm10
# variable ('F', 11) maps to %ymm11
# variable ('F', 12) maps to %ymm12
# variable ('F', 13) maps to %ymm13
# variable sum maps to %ymm14
# variable zero maps to %ymm15
# variable mask maps to %r10d

# load the most-frequently used derivatives (F[0]...F[13]) into %xmm registers
vmovdqa 0(%rdi), %ymm0   ## %ymm0 = F[0]
vmovdqa 32(%rdi), %ymm1   ## %ymm1 = F[1]
vmovdqa 64(%rdi), %ymm2   ## %ymm2 = F[2]
vmovdqa 96(%rdi), %ymm3   ## %ymm3 = F[3]
vmovdqa 128(%rdi), %ymm4   ## %ymm4 = F[4]
vmovdqa 160(%rdi), %ymm5   ## %ymm5 = F[5]
vmovdqa 192(%rdi), %ymm6   ## %ymm6 = F[6]
vmovdqa 224(%rdi), %ymm7   ## %ymm7 = F[7]
vmovdqa 256(%rdi), %ymm8   ## %ymm8 = F[8]
vmovdqa 288(%rdi), %ymm9   ## %ymm9 = F[9]
vmovdqa 320(%rdi), %ymm10   ## %ymm10 = F[10]
vmovdqa 352(%rdi), %ymm11   ## %ymm11 = F[11]
vmovdqa 384(%rdi), %ymm12   ## %ymm12 = F[12]
vmovdqa 416(%rdi), %ymm13   ## %ymm13 = F[13]
# initialize the last things that remains to be intialized...
movq (%rcx), %r9  ## num = *num_ptr
vpxor %ymm15, %ymm15, %ymm15   ## zero = 0


##### step 1 [hw=1]
##### F[ 0 ] ^= ( F[ 1 ] ^= ( F[ alpha + 1 ])))

vpxor 32(%rdi,%rsi), %ymm1, %ymm1
vpxor %ymm1, %ymm0, %ymm0
vpcmpeqd %ymm0, %ymm15, %ymm15
vpmovmskb %ymm15, %r10d
test %r10d, %r10d
...
vmovdqa 192(%rdi,%rsi), %ymm14
vpxor 512(%rdi), %ymm14, %ymm14
...
vmovdqa 224(%rdi,%rsi), %ymm14
vpxor 704(%rdi), %ymm14, %ymm14
...
vmovdqa 256(%rdi,%rsi), %ymm14
vpxor 928(%rdi), %ymm14, %ymm14
...
vmovdqa 288(%rdi,%rsi), %ymm14
vpxor 1184(%rdi), %ymm14, %ymm14
vmovdqa %ymm14, 1184(%rdi)
vpxor %ymm14, %ymm0, %ymm0
vpcmpeqd %ymm0, %ymm15, %ymm15
vpmovmskb %ymm15, %r10d
test %r10d, %r10d
