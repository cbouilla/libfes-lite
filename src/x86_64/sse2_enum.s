...
movdqa 0(%rsi), %xmm0   ## %xmm0 = Fl[0]
movdqa 16(%rsi), %xmm1   ## %xmm1 = Fl[1]
movdqa 32(%rsi), %xmm2   ## %xmm2 = Fl[2]
movdqa 48(%rsi), %xmm3   ## %xmm3 = Fl[3]
movdqa 64(%rsi), %xmm4   ## %xmm4 = Fl[4]
movdqa 80(%rsi), %xmm5   ## %xmm5 = Fl[5]
movdqa 96(%rsi), %xmm6   ## %xmm6 = Fl[6]

movdqa 0(%rdi), %xmm7   ## %xmm7 = Fq[0]
movdqa 16(%rdi), %xmm8   ## %xmm8 = Fq[1]
movdqa 32(%rdi), %xmm9   ## %xmm9 = Fq[2]
movdqa 48(%rdi), %xmm10   ## %xmm10 = Fq[3]
movdqa 64(%rdi), %xmm11   ## %xmm11 = Fq[4]
movdqa 80(%rdi), %xmm12   ## %xmm12 = Fq[5]
movdqa 128(%rdi), %xmm13   ## %xmm13 = Fq[8]
...
pxor 96(%rdi, %rdx), %xmm14
movdqa %xmm14, 112(%rsi)
pxor %xmm14, %xmm0
...
._step_127_end:
movdqa 128(%rsi), %xmm14
pxor 112(%rdi, %rdx), %xmm14
movdqa %xmm14, 128(%rsi)
pxor %xmm14, %xmm0
...
movdqa %xmm1, 16(%rsi)     #Fl[1] <-- %xmm1
movdqa %xmm2, 32(%rsi)     #Fl[2] <-- %xmm2
movdqa %xmm3, 48(%rsi)     #Fl[3] <-- %xmm3
movdqa %xmm4, 64(%rsi)     #Fl[4] <-- %xmm4
movdqa %xmm5, 80(%rsi)     #Fl[5] <-- %xmm5
movdqa %xmm6, 96(%rsi)     #Fl[6] <-- %xmm6
...
._step_255_end:
movdqa (%rsi, %rcx), %xmm14
pxor (%rdi, %r8), %xmm14
movdqa %xmm14, (%rsi, %rcx)
pxor %xmm14, %xmm0

# Save Fl[0] back to memory
movdqa %xmm0, (%rsi)     #F l[0] <-- %xmm0
...
pxor %xmm15, %xmm15     # reset %xmm15 to zero
